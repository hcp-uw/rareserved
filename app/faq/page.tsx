...
export default async function ProtectedPage() {
  ...
  <PartialDivider/>
    <h2>How does the club work? What does each club subteam do?</h2>
    ...
    <h2>When and where does the club meet? How can I stay updated?</h2>
    ...
    <h2>What does a typical meeting look like?</h2>
    ...
    <h2>Does the club provide any academic or career support?</h2>
    ...
    <h2>Can I suggest ideas for events or activities?</h2>
